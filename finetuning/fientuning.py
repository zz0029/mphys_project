...
from datamodules import RGZ_DataModule_Finetune, MIGHTEE_DataModule_Finetune, MIGHTEE_RGZ_DataModule_Fine
...
def main():
    ...
    for seed in range(config_finetune["finetune"]["iterations"]):
        ...
        project_name = "BYOL_finetune_" + config["finetune"]["dataset"]
